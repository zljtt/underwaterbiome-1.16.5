...
@OnlyIn(Dist.CLIENT)
public class ConchModel extends EntityModel<Conch> {
	...
	@Override
	public void setupAnim(Conch entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
			float headPitch) {
